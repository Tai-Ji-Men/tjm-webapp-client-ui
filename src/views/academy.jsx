      ...
      <div className="relative w-full bg-white">
        ...
        {selectedAcademy && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
              <div className="relative w-full max-w-[1400px] h-[90vh] max-h-[800px] bg-white rounded-[20px] overflow-hidden shadow-2xl">
                {/* Close Button */}
                <button
                ...
                <div className="flex h-full flex-col md:flex-row">
                  ...
                  {/* Right Side - Details */}
                  <div className="w-full md:w-2/5 h-1/2 md:h-full bg-white p-6 md:p-10 flex flex-col justify-between overflow-y-auto">
                    <div>
                    ...
                    <div className="flex gap-4 md:gap-6">
                      <button className="flex-1 flex flex-col items-center justify-center gap-3 py-6 md:py-8 bg-white border-2 border-[#FF725E] rounded-[20px] hover:bg-[#FFF5F3] transition-colors group">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-[#FF725E] flex items-center justify-center">
